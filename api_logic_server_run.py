...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.03.16, March 03, 2024 19:01:15):
...
app_logger.info(f'Created March 03, 2024 19:01:15 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.03.16\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.03.16\n'
    msg += f'.. startup message: {start_up_message}\n'
